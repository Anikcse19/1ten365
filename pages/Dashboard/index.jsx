...
const Dashboard = () => {
  ...
  return (
    <div className="p-5 border border-red-600 w-screen min-h-screen ">
      ...
      <div className="flex gap-x-5 w-full justify-center mt-10">
        <Link href="/Dashboard/AddAdmin">
          <button className=" border border-slate-400 px-10 py-1.5 text-white bg-slate-900 rounded-md">
            Add Admin
          </button>
        </Link>
      ...
      <div className="lg:w-[350px] mx-auto mt-10">
        <label className="text-gray-700 dark:text-gray-200">Select Quick Agent</label>
