...
import conditionposter from "../../../public/images/1ten365/1ten T&C.png";
          ...
          <div className=" border border-gray-400 p-10">
                ...
                <span className="my-2 font-medium text-lg">
                  ...
                  <p>
                    ** ওয়েবসাইট টি যেহেতু বেটফেয়ার এর মাধ্যমে চলে – সেহেতু
                    ...
                    বেট সাইটে বেট করতে হলে আপনাকে বেটফেয়ার এবং ভেল্কি র
            ...
            <div className="text-lg my-5">
              <span>
                ...
                <p>
                  ** এজেন্ট যদি ভুল করে কোন পয়েন্ট ডিপোজিট করে ফেলে – তাহলে
                  ...
                  পয়েন্ট দিয়ে বেট ধরে ফেলেন – এজেন্ট বা ভেল্কি ম্যানেজমেন্ট এর
                ...
                <p>
                  ** ভেল্কি তে হোয়াটসাপ ছাড়া আর কোন এপ দিয়ে লেনদেন করা যাবে
                  না।।
                </p>
                <p>
                  ** ভেল্কি এর একটি আইডি র জন্য একজন ইউজার একের অধিক হোয়াটসাপ
                  ব্যবহার করতে পারবে না।
                </p>
                <p>
                  ** ভেল্কি তে একটি হোয়াটসাপ দিয়ে একের অধিক আইডি খোলা যাবে না।
                </p>
                <p>
                ...
                <p>
                  ** মাঝে মাঝে বেটফেয়ার স্কোর ভুল দেখায় – এই জন্য ইউজারদের কে,
                  ভেল্কি এর পাশাপাশি অন্য সাইট থেকেও স্কোর দেখার জন্য নির্দেশ
                  দেয়া হচ্ছে।
                </p>
                <p>
              ...
              <span>
                ...
                <p>
                  ** বেটফেয়ার বা ভেল্কি যে কোন বেট যে কোন সময়ে বাতিল করতে
                  পারে।
                </p>
                <p>
                ...
                <p>
                  ** বেট কেন বাতিল হল – তার কারন আমরা জানার চেষ্টা করতে পারি –
                  ভেল্কি বা বেটফেয়ার থেকে। কারন হিসাবে তারা যাই বলবে তাই ইউজার
                  কে মেনে নিতে হবে।
                </p>
              </span>
            </div>
